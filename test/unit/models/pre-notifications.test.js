...
test.each([
  ...
  {
    controlAuthority: { iuuOption: null },
    iuuDecisionDisplay: 'Decision not given'
  },
  {
    controlAuthority: { iuuOption: 'IUUOK' },
    iuuDecisionDisplay: 'IUU inspection complete'
  },
  {
    controlAuthority: { iuuOption: 'IUUNotCompliant' },
    iuuDecisionDisplay: 'IUU not compliant'
  },
  {
    controlAuthority: { iuuOption: 'IUUNA' },
    iuuDecisionDisplay: 'IUU inspection not applicable'
  }
  ...
  const expected = [
    {
      commodities: [
        {
          checks: [{ authority: 'PHSI', decision: 'Auto cleared' }],
...
test('CHEDPP: null commodity checks', () => {
  const data = {
    importPreNotifications: [
      {
        importPreNotification: {
