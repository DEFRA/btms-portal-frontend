...
describe('GMR search result', () => {
  ...
  test('Should render page', () => {
    ...
    expect($renderedTemplate.html()).toContain('<span class="vehicle-number-plate vehicle-number-plate--front" aria-label="Vehicle registration number ABC 111">ABC 111</span>')
    expect($renderedTemplate.html()).toContain('<span class="vehicle-number-plate vehicle-number-plate--rear" aria-label="Trailer registration number ABC 222">ABC 222</span>')
    expect($renderedTemplate.html()).toContain('<span class="vehicle-number-plate vehicle-number-plate--rear" aria-label="Trailer registration number ABC 333">ABC 333</span>')
