...
test('shows search results', async () => {
  ...
  const declarationMatchFilter = getByRole(document.body, 'combobox', {
    name: 'Match'
  })
  ...
  const declarationDecisionFilter = getByRole(document.body, 'combobox', {
    name: 'Decision'
  })
  ...
  const [declarationAuthorityFilter] = getAllByRole(document.body, 'combobox', {
    name: 'Authority'
  })
  ...
  const notificationAuthorityFilter = getAllByRole(document.body, 'combobox', {
    name: 'Authority'
  })[1]
